...
var HUD_POSITIONS = {
    ...
    CENTER_TOP: new pixi_js_1.Point(MAX_X * 0.50, 10),
...
var Hud = /** @class */ (function (_super) {
    ...
    Hud.prototype.addRandomContainer = function (name, opts) {
        ...
        for (var i = 0; i < 3; i++) {
            ...
            var positionX = lastElementWidth + options.textMargin;
...
var Card = /** @class */ (function () {
    ...
    Card.prototype.move = function (elapsedTime) {
        ...
        if (elapsedTime > 0) {
            ...
            //card should move to the expectedPosition but added some values for good visual effect
