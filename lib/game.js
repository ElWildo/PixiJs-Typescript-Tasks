...
var Hud = /** @class */ (function (_super) {
    ...
    Hud.prototype.addRandomContainer = function (name, opts) {
        ...
        for (var i = 0; i < 3; i++) {
            ...
            if (randomElement == 0) {
                ...
                var sprite = new PIXI.Sprite(this.loader.resources[options.spritesheet].textures[options.spriteName]);
                //some calculation about text and sprite position x in grid
                middleElementWidth = i == 1 ? sprite.width : middleElementWidth;
                var positionX = this.getPosition(i, (i == 2 ? middleElementWidth : sprite.width), options.textMargin);
                ...
                var positionX = this.getPosition(i, (i == 2 ? middleElementWidth : textBox.width), options.textMargin);
     ...
     */
    Hud.prototype.getPosition = function (i, width, margin) {
        switch (i) {
            case 0:
...
var Card = /** @class */ (function () {
    ...
    Card.prototype.move = function (elapsedTime) {
        ...
        if (elapsedTime > 0) {
            ...
            var resultX = (this.expectedPosition.x + 500 - this.startPosition.x);
            if (resultX > 0)
